                ...
                {{-- <div class="row page-bg"> --}}
                    <div class="p-4">
                        <div class="text-center top-icon">
                            ...
                            {{-- <form id="form-create" action="{{ route('books.update', $book->slug) }}" method="post"> --}}
                                @csrf
                                ...
                                <div class="mt-3 mb-3 form-floating">
                                    ...
                                    value="{{ $book->category_id }}" readonly>
                                ...
                                <div class="mt-3 mb-3 form-floating">
                                    <input type="text" class="form-control form-control-lg" name="category" placeholder="1"
                                    value="{{ $book->category->name }}" readonly>
                                    <label for="category"> Kategori Buku</label>                                      
                                </div>

                                @error('category')
                                <div class="alert alert-danger"> Kategori Buku Error </div>
                                @enderror

                                <div class="mt-3 mb-3 form-floating">
                                    <input type="number" class="form-control form-control-lg" name="author_id" placeholder="1"
                                    value="{{ $book->author_id }}" readonly>
                                ...
                                <div class="mt-3 mb-3 form-floating">
                                    ...
                                    <label for="author"> ID Penulis Buku</label>                                      
                                </div>
                            ...
                            <div class="mt-4 text-center submit-btn">
                                <a href="{{ route("index.books") }}" class="btn btn-primary">Kembali</a>
                            </div>
